<%@ Page Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeFile="LayoutBus_2-1_32.aspx.cs" Inherits="LayoutBus_2_1_32" Title="Untitled Page" %>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="height: 371px">
                    ...
                    <tr>
                        <td colspan="2" class="bus-bg" style="width: 463px; padding: 10px 70px 10px 70px;"
                            ...
                            <br />
                            <table id="tbl_35" cellpadding="5" cellspacing="0" style="float: left; border: solid 2px silver">
                                <tr>
                                    <td>
