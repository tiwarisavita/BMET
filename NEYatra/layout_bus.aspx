<%@ Page Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeFile="layout_bus.aspx.cs" Inherits="clsBusLayout" Title="BuyMyETicket :: Bus Layout" %>
                        ...
                        <td colspan="2" class="bus-bg" style="width: 463px; padding: 10px 70px 10px 70px;"
                            ...
                            <table id="tbl_35" cellpadding="5" cellspacing="0" style="float: left; border: solid 2px silver">
                                <tr>
                                    ...
                                    <td>
                                        <b>4</b><img src="images/purple-seat.png" id="img4" alt="Seat 4" onclick="imgclick1('img6')"
                                            title="Free" />
                                    </td>
                                    <td>
