<%@ Page Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeFile="LayoutBus_2-1_37.aspx.cs" Inherits="LayoutBus_2_1_37" Title="BuyMyETicket.com :: Bus Layout 2*1(37 Seater)" %>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="height: 371px">
                    ...
                    <tr>
                        <td colspan="2" class="bus-bg" style="width: 463px; padding: 10px 70px 10px 70px;"
                            ...
                            <br />
                            <table id="tbl_37" cellpadding="3" cellspacing="0" style="float: left; border: solid 2px silver">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <b>30</b><img ID="img30" alt="Seat 30" onclick="imgclick1('img30')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                    <td>
                                        <b>32</b><img ID="img32" alt="Seat 32" onclick="imgclick1('img32')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                    <td>
                                        <b>37</b><img ID="img37" alt="Seat 37" onclick="imgclick1('img37')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b>29</b><img ID="img29" alt="Seat 29" onclick="imgclick1('img29')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                    <td>
                                        <b>31</b><img ID="img31" alt="Seat 31" onclick="imgclick1('img31')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                    <td>
                                        <b>36</b><img ID="img36" alt="Seat 36" onclick="imgclick1('img36')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <b>35</b><img ID="img35" alt="Seat 35" onclick="imgclick1('img35')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b>34</b><img ID="img34" alt="Seat 34" onclick="imgclick1('img34')" 
                                            src="images/purple-seat.png" title="Free" />
                                    </td>
